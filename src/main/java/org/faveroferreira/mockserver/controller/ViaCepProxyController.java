...
import org.faveroferreira.mockserver.chaos.failure.SucceedXTimesFailYTimesAndThenSucceed;
...
public class ViaCepProxyController {
    ...
    PotentialFailure potentialFailure = new SucceedXTimesFailYTimesAndThenSucceed(5, 7);
